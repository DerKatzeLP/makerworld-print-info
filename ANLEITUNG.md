...
## 🎯 Ziel
Eine Chrome Extension erstellen, die auf der MakerWorld-Übersichtsseite automatisch **Druckzeit** und **Gewicht** für jedes Modell anzeigt.
...
```json
{
  "pageProps": {
    "design": {
      ...
      "instances": [
        {
          "prediction": 3600,    // Druckzeit in Sekunden
          "weight": 125.5        // Gewicht in Gramm
        }
      ]
    }
  }
